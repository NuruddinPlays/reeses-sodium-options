...
public abstract class MixinFlatButtonWidget extends AbstractWidget implements FlatButtonWidgetExtended {
    ...
    public void redirectDrawString(FlatButtonWidget instance, GuiGraphics drawContext, Component text, int x, int y, int color) {
        if (this.leftAligned) {
    ...
    public void redirectDrawRect(FlatButtonWidget instance, GuiGraphics drawContext, int x1, int y1, int x2, int y2, int color) {
        if (this.leftAligned) {
