...
public class SodiumVideoOptionsScreen extends Screen implements ScreenPromptable {
    ...
    private void checkPromptTimers() {
        ...
        /*if (FabricLoader.getInstance().isDevelopmentEnvironment()) { //fixme:
            //return;
        }*/
        ...
        if (options.notifications.hasClearedDonationButton || options.notifications.hasSeenDonationPrompt) {
            return;
        }
    ...
    private void applyChanges() {
        ...
        /*if (flags.contains(OptionFlag.REQUIRES_GAME_RESTART)) { //todo:
    ...
    public boolean keyPressed(int keyCode, int scanCode, int modifiers) {
        if (keyCode == GLFW.GLFW_KEY_P && (modifiers & GLFW.GLFW_MOD_SHIFT) != 0 && !(this.searchTextField != null && this.searchTextField.isFocused())) {
            this.minecraft.setScreen(new VideoSettingsScreen(this.prevScreen, this.minecraft.options));
